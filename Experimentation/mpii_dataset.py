...
def save_joints():
    joint_data_fn = 'Data/mpii_human_pose_v1/data.json'
    mat = loadmat('Data/mpii_human_pose_v1/mpii_human_pose_v1_u12_1.mat')
...
def split_train_test():
    fp_test = open('data/mpii_human_pose_v1/test_joints.csv', 'w')
    fp_train = open('data/mpii_human_pose_v1/train_joints.csv', 'w')
    all_data = open('data/mpii_human_pose_v1/data.json').readlines()
    N = len(all_data)
    N_test = int(N * 0.1)
    N_train = N - N_test
